<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="executive.aspx.cs" Inherits="otel.web_otel.HAKKIMIZDA.executive" %>
...
<body>
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server" />
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="slider">
                <img src="img2/executive.jpg" class="active" alt="Oda Resmi 1">
                <img src="img2/executive2.jpg" alt="Oda Resmi 2">
                <img src="img2/executive3.jpg" alt="Oda Resmi 3">
                <div class="arrow left-arrow">❮</div>
                <div class="arrow right-arrow">❯</div>
            </div>

            <div class="room-details">
                <h3>EXECUTIVE CLUB ODA</h3>
                <div class="columns">
                    <div>
                        <h4>ODA ÖZELLİKLERİ</h4>
                        <ul>
                            <li>Göl & Deniz veya Şehir Manzaralı</li>
                            <li>1 yatak odası (King Size Bed)</li>
                    ...
                    <div>
                        ...
                        <ul>
                            <li>LED TV</li>
                            <li>Şifresiz Ücretsiz İnternet Bağlantısı</li>
                        </ul>
                    </div>
                </div>
            </div>
